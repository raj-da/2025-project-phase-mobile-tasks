...
// in ecommerce_ui_clone/test/features/chat/data/datasources/chat_remote_data_source_impl_test.dart.
...
class MockAuthLocalDataSourceImpl extends _i1.Mock
    implements _i11.AuthLocalDataSourceImpl {
  MockAuthLocalDataSourceImpl() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i8.SharedPreferences get sharedPreferences =>
      (super.noSuchMethod(
  ...
  @override
  _i9.Future<void> cacheAuthToken({required String? authToken}) =>
      (super.noSuchMethod(
